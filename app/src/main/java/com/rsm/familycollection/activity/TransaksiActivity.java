...
import com.rsm.familycollection.adapter.AdapterProdukTransaksi;
    ...
    private void initData() {
        ...
        showOrderCall.enqueue(new Callback<ShowOrder>() {
            ...
            public void onResponse(Call<ShowOrder> call, Response<ShowOrder> response) {
                ...
                final String urlGambarBerita = "https://ta-mifpolije.com/E31202463/public/storage/" + response.body().getOrderDetail().getImage();
                ...
                if (response.body().getOrderDetail().getNegosiasi() != null ){
                    textTanggal.setText("Negosiasi: "+response.body().getOrderDetail().getNegosiasi());
                }
